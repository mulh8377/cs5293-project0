...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/mulh8377/Courses/TextAnalyis/projects/cs5293-project0/nimcache/stdlib_unicode.o /home/mulh8377/Courses/TextAnalyis/projects/cs5293-project0/nimcache/stdlib_unicode.c */
...
N_NIMCALL(NimStringDesc*, nuctoUTF8)(NI32 c) {
	...
	LA6_: ;
	{
		...
		result->data[((NI) 1)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 6))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
	...
	LA9_: ;
	{
		...
		result->data[((NI) 1)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 12))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 2)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(188, "unicode.nim");
		result->data[((NI) 2)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 6))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
	...
	LA12_: ;
	{
		...
		result->data[((NI) 1)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 18))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 2)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(195, "unicode.nim");
		result->data[((NI) 2)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 12))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 3)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(196, "unicode.nim");
		result->data[((NI) 3)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 6))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
	...
	LA15_: ;
	{
		...
		result->data[((NI) 1)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 24))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 2)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(203, "unicode.nim");
		result->data[((NI) 2)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 18))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 3)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(204, "unicode.nim");
		result->data[((NI) 3)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 12))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
		if ((NU)(((NI) 4)) > (NU)(result->Sup.len)) raiseIndexError();
		nimln_(205, "unicode.nim");
		result->data[((NI) 4)] = ((NIM_CHAR) (((NI)chckRange((NI)(((NI) ((NI32)((NI32)((NU32)(i) >> (NU64)(((NI) 6))) & ((NI32) 63)))) | ((NI) 128)), ((NI) 0), ((NI) 255)))));
